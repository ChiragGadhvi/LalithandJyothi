...
function HomeComponent() {
    ...
    const AandS = Array.from({ length: 6 }, (_, index) => `/WORKS1/ANU_SASHI/${index + 1}.jpg`);
    const AandH = Array.from({ length: 8 }, (_, index) => `/WORKS1/ANITHA_HARSHA/${index + 1}.jpg`);
    const AN =  Array.from({ length: 6 }, (_, index) => `/WORKS1/AZIZ_NAGAR/${index + 1}.jpg`);
    const RandP=  Array.from({ length: 6 }, (_, index) => `/WORKS1/RAMA_PRADEEP/${index + 1}.jpg`);
    ...
    return (<>
        <nav className="navbar navbar-expand-lg navbar-light bg-light" style={{ position: 'fixed', top: 0, width: '100%', zIndex: 1000 }}>
            <div className="container-fluid">
                <a className="navbar-brand" href="#">
                    <img src="/LOGO.jpg" loading="lazy" alt="Logo" width="60%" height="100%" className="d-inline-block align-text-top logo" />
                </a>
                <button className="navbar-toggler border border-0 p-0" type="button" onClick={handleToggle} aria-controls="navbarSupportedContent" aria-expanded={isOpen} aria-label="Toggle navigation">
                    <span className="navbar-toggler-icon"></span>
                </button>
                <div className={`collapse navbar-collapse ${isOpen ? 'show' : ''}`} id="navbarSupportedContent">
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <a className="fw-medium nav-link active" aria-current="page" href="#profile">PROFILE</a>
                        </li>
                        <li className="nav-item">
                            <a className="fw-medium nav-link active" href="#work" onClick={handleLinkClick}>WORKS</a>
                        </li>
                        <li className="nav-item">
                            <a className="fw-medium nav-link active" href="#publishing" onClick={handleLinkClick}>FEATURES</a>
                        </li>
                        <li className="nav-item">
                            <a className="fw-medium nav-link active" href="#blog" onClick={handleLinkClick}>BLOG</a>
                        </li>
                        <li className="nav-item">
                            <a className="fw-medium nav-link active" href="#contact" onClick={handleLinkClick}>CONTACT</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="carousel slide" id="carouselDemo" data-bs-wrap="true" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img loading="lazy" src={isMobile ? "/mobile3.jpeg" : "/1.jpg"} className="d-block w-100" alt="Slide 1" />
                    </div>
                    <div className="carousel-item" data-bs-interval="2000">
                        <img loading="lazy" src={isMobile ? "/mobile2.jpeg" : "/2.jpg"} className="d-block w-100" alt="Slide 2" />
                    </div>
                    <div className="carousel-item">
                        <img loading="lazy" src={isMobile ? "/Mobile1.jpeg" : "/3.jpg"} className="d-block w-100" alt="Slide 3" />
                    </div>
                </div>
                ...
                <div className="carousel-indicators">
                    <button type="button" className="active" data-bs-target="#carouselDemo" data-bs-slide-to="0"></button>
            ...
            <div className="row">
                <div className="col-sm-4" onClick={() => openModal('AandS')}>
                    <div className="mt-4 card-mag">
                        <img loading="lazy" src="/WORKS1/ANU_SASHI/1.jpg" className="magazine-cover" />
                    </div>
                    <div className="col clientNames text-center mt-1">
                        <span className="fw-medium">ANU & SASHI</span>
                    </div>
                ...
                <div className="col-sm-4" onClick={() => openModal('AandH')}>
                    <div className="mt-4 card-mag">
                        <img loading="lazy" src="/WORKS1/ANITHA_HARSHA/1.jpg" className="magazine-cover" />
                    </div>
                    <div className="col clientNames text-center mt-1">
                        <span className="fw-medium">SHANTHI & SRINIVAS</span>
                    </div>
                ...
                <div className="col-sm-4" onClick={() => openModal('AZ')}>
                    <div className="mt-4 card-mag">
                        <img loading="lazy" src="/WORKS1/AZIZ_NAGAR/1.jpg" className="magazine-cover" />
                    </div>
                    <div className="col clientNames text-center mt-1">
                ...
                <div className="col-sm-4" onClick={() => openModal('RandP')}>
                    <div className="mt-4 card-mag">
                        <img loading="lazy" src="/WORKS1/RAMA_PRADEEP/1.jpg" className="magazine-cover" />
                    </div>
                    <div className="col clientNames text-center mt-1">
                        <span className="fw-medium">RAMA & PRADEEP</span>
                    </div>
        ...
        <section className="magazine-section mt-5" >
            <div className="mag-div text-center mt-0">
                <h2 id="">MAGAZINES</h2>
                <div className="row">
                    <div className="col-sm-4">
                        <div className=" mt-4 card-mag">
                            <img loading="lazy" src="/MAGAZINES/MAGAZINES/APOORVA/1.jpg" className="magazine-cover" />
                        </div>
                    </div>
                    <div className="col-sm-4">
                        <div className=" mt-4 card-mag">
                            <img loading="lazy" src="/MAGAZINES/MAGAZINES/HOME-AND-DEISGN-TRENDS/0.jpg" className="magazine-cover" />
                        </div>
                    </div>
                    <div className="col-sm-4">
                        <div className=" mt-4 card-mag">
                            <img loading="lazy" src="/MAGAZINES/MAGAZINES/INDIAN-TODAY-HOMES/1.jpg" className="magazine-cover" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section className="profile-section mb-5">
            <div className="row mt-4 d-flex justify-content-center text-center ">
                ...
                <div className="card mt-4 profile-card" style={{ width: '35vw' }}>
                    <img loading="lazy" src="/MAGAZINES/MAGAZINES/HOME-AND-DEISGN-TRENDS/0.jpg" className="card-img-top " alt="..." />
                    <div className="card-body">
                        ...
                        <p className="card-text fw-medium "><em>Graduate in architecture from the university college of architecture - Andhra university. Craft centric design approach. Weaves spaces with diverse complexities of material and textures.</em></p>
                ...
                <div className="card mt-4 profile-card" style={{ width: '35vw' }}>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text fw-medium  ms-2"> <em>Graduate in architecture from the university college of architecture - Andhra university. Enjoys design as a process emerging form the non programmed moments.And then to weave those moments into the material forms.</em></p>
                    </div>
                </div>
        ...
        <section className='Contact-section mt-mb-5 '>
            <div className="contactDiv row d-flex justify-content-end m-4 mb-5">
                <div className="col-md-12">
                    <div className="mt-4 mt-md-0">
                        <h2>Contact</h2>
                        <div className='d-flex align-items-center mt-3'>
                            <h6 className="p-0 m-0 me-4 fw-medium">Hemu, Vittal Rao Nagar, HITEC City, Hyderabad, Telangana 500081</h6>
                        </div>
                        ...
                        <div className="row align-items-center mt-2 p-0">
                            ...
                            <div className="col-12 col-md-auto d-flex align-items-center mt-2">
                                <h6 className="p-0 m-0 fw-medium" style={{ fontSize: '0.9rem' }}>+91-9704475888</h6>
                            </div>
                        </div>
